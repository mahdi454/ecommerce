    ...
    <>
      <MaxWidthWrapper>
        <div className="py-20  mx-auto text-center flex flex-col items-center max-w-3xl">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl sm:font-extrabold">
            It smells comfortable and elegant
          </h1>
          <p className="mt-6 text-lg max-w-prose text-muted-foreground tracking-wide">
